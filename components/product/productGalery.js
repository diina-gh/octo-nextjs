...
export default function ProductGalery() {
  ...
  return (
    <div className="">
      ...
      <Swiper className="swiper-type2 mt-4" onSwiper={setThumbsSwiper} spaceBetween={10} slidesPerView={4} freeMode={true} watchSlidesProgress={true} modules={[FreeMode, Navigation, Thumbs]} >
