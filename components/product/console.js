...
export default function Console(props) {
  ...
  return (
    <div className="h-7 flex flex-row self-center">
        <div className="h-full w-7 flex flex-row justify-center border border-gray-800 rounded-md gt-shadow1 btn-effect1 cursor-pointer mr-2">
        ...
        <div className="h-full w-7 flex flex-row justify-center border border-gray-800 rounded-md gt-shadow1 btn-effect1 cursor-pointer ml-2">
            <div className="self-center text-lg font-semibold text-gray-800">+</div>
        </div>
    </div>
  );
