                ...
                <div className="fixed inset-y-0 right-0 pl-10 max-w-full flex">
                    ...
                    <div className="w-screen max-w-md">
                        ...
                        <div className="flex-1 py-6 overflow-y-auto px-4 sm:px-6">
                            ...
                            <Dialog.Title className="text-lg font-medium text-gray-100">Mon panier (3)</Dialog.Title>
                            ...
                            <div className="flow-root">
                                ...
                                {products.map((product) => (
                                    ...
                                    <div className="flex-shrink-0 w-24 h-24 flex flex-row justify-center rounded-xl bg-gray-400 bg-opacity-20 overflow-hidden">
                        ...
                        <div className="border-t border-gray-600 py-6 px-4 sm:px-6">
                            ...
                            <a
                                href="#"
                                className="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white gt-bg-gradient"
                            >
                                Commander
                            </a>
                            </div>
