...
import { UserIcon, ShoppingCartIcon, SearchIcon, XIcon } from '@heroicons/react/outline'
...
export default function Header(props) {
    ...
    return (
        <header className="w-full h-20 bg-gray-100 bg-opacity-0 flex flex-col justify-center px-7 sm:px-16 md:px-20 lg:px-24 xl:px-28 2xl:px-48">
