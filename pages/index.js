          ...
          <div className="w-full flex flex-col md:flex-row-reverse justify-between items-center">
              ...
              <div className="w-full md:w-7/12 flex-auto">
                ...
                <div class="sm:text-center lg:text-left">
                  ...
                  <p class="mt-3 text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
