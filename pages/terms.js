        ...
        <section className="px-7 sm:px-16 md:px-20 lg:px-24 xl:px-28 2xl:px-48 mt-10">
            ...
            <div className="text-center">
                <h2 className="max-w-lg mb-2 text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                    ...
                    <span className='z-10'>Conditions générales</span>

                </h2>
                <p className="text-base text-gray-500 md:text-lg">Dernière mise à jour : 21 février 2020</p>
            </div>

            <div className="mt-14">
                <h2 className="mb-2 text-xl font-bold" id="1legalnotices">1. Legal Notices</h2>

                <p className="mb-2 leading-6">We, the Operators of this Website, provide it as a public service to our users.</p>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="2permittedandprohibiteduses">2. Permitted and Prohibited Uses</h2>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="3usersubmissions">3 User Submissions</h2>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="4userdiscussionlistsandforums">4. User Discussion Lists and Forums</h2>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="5useofpersonallyidentifiableinformation">5. Use of Personally Identifiable Information</h2>

                <p className="mb-2 leading-6">Information submitted to the Website is governed according to the Operators’s current Privacy Policy and the stated license of this website.</p>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="7termination">7. Termination</h2>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="9general">9. General</h2>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="10linkstoothermaterials">10. Links to Other Materials</h2>
                ...
                <h2 className="mt-8 mb-4 text-xl font-bold" id="11notificationofpossiblecopyrightinfringement">11. Notification Of Possible Copyright Infringement</h2>

                <p className="mb-2 leading-6">In the event you believe that material or content published on the Website may infringe on your copyright or that of another, please <a href="#">Contact Us</a>.</p>
